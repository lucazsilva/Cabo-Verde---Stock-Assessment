...
length-frequency data only;
catch data only;
combined length and catch data;
integrated length, catch, and fishing-effort data. 

The project aims to compare assessment approaches across contrasting data scenarios and explore how increasing data availability influences stock assessment results and management-relevant indicators.

...
ct<- read.csv("Desembarques cavala_1989-2023.csv",sep = ";",dec = ".") #CAPTURAS DE ESFORÇO MACARELLUS
...
# ---------------------------------------------------------------------
ggsave( filename = "capturas_Decapterus_macarellus.png", plot = p_ct, device = "png",
  units = "cm",  width = 25,  height = 15,  dpi = 300,  bg = "white")
...
## ---------------------------------------------------------------------
# Mesmo ajuste feito nos boxplots do DB-SRA: mar[1]=8 igual em todo
# painel do mfrow inflava o vao acima dos titulos de cima e MESMO ASSIM
# cortava os rotulos de baixo, que sao os 16 nomes de cenario (compridos)
# encostando na borda do PNG. Troca: mar[1] menor e igual em todo painel
# (6) + oma so na base da FIGURA TODA (nao repetida por painel), que da
# o espaco extra so onde falta -- embaixo dos paineis de baixo. xpd = NA
...
png("comparacao_cenarios_cmsy.png", width = 28, height = 22,
    res = 300, antialias = "cleartype", units = "cm")
op <- par(mfrow = c(2, 2), mar = c(6, 4.5, 3, 1), oma = c(6, 0, 0, 0),
          bty = "l", cex = 0.8, cex.main = 0.9)
